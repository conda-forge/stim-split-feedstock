About libstim-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/stim-split-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/quantumlib/Stim
      ...
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=27355&branchName=main">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/stim-split-feedstock?branchName=main">
          </a>
        </summary>
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=27355&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/stim-split-feedstock?branchName=main&jobName=win&configuration=win%20win_64_" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
Installing `libstim` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
```
conda search libstim --channel conda-forge
```

or with `mamba`:

```
mamba search libstim --channel conda-forge
```
...
mamba repoquery search libstim --channel conda-forge

# List packages depending on `libstim`:
mamba repoquery whoneeds libstim --channel conda-forge

# List dependencies of `libstim`:
mamba repoquery depends libstim --channel conda-forge
```
...
Updating libstim-feedstock
==========================

If you would like to improve the libstim recipe or build a new
...
Note that all branches in the conda-forge/libstim-feedstock are
